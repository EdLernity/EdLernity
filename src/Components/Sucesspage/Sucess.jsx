...
//     return (
//         <div>
//             <h1 className='text-2xl text-center font-semibold' style={{ color: "#1649FF" }}>Stay in the  loop  with the  latest updates in the tech industry</h1>
//             <div className='flex justify-center rounded-lg mt-8'><Button className=''>Success Stories</Button></div>
...
//                     </div> */}
//                 <div className="ml-2 flex items-center flex-row" style={{ marginLeft: '20px' }}>
...
//             {/* below add it success stories fo the student in carosuel form */}
//             <div className="flex justify-center mt-8 -space-x-4 items-center relative">
...
//                     <div key={story.id} className={`slide ${index >= currentSlide && index < currentSlide + 4 ? 'visible' : 'hidden'}`}>
//                         <div className="card w-full max-w-md mx-auto">
//                             {/* Profile and Internship Details */}
...
//                                         <StarIcon key={starIndex} className="w-5 h-5 text-yellow-500 ml-2" />
//                                     ))}
//                                 </div>
//                                 {/* Internship Details */}
...
//     {/* Carousel Content */}
//     {successStories.map((story, index) => (
//         <div key={story.id} className={`slide ${index === currentSlide ? 'visible' : 'hidden'}`}>
//             <div className="card w-full max-w-md mx-auto">
//                 {/* Profile and Internship Details */}
//                 <div className="p-4 border">
//                     <Avatar
