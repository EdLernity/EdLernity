...
//     {
//         title: "Company",
//         items: ["Our Company", "Student Stories", "Contact Us", "About Us", "Help and Support"],
//     },
//     {
//         title: "Legal",
//         items: ["Privacy Policy", "Term and Condition",],
//     },
//     {
//         title: "Contact",
//         items: ["+91 8073306479", "info@edlernity.com",],
//     },
// ];
...
//                 <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2 max-sm:px-8">
...
//                     >
//                         &copy; {currentYear} <Link to="/">EdLernity</Link>. All
//                         Rights Reserved.
//                     </Typography>
...
function Footer() {
    ...
    {LINKS.map(({ title, items }) => (
        <ul key={title} className="text-center"> {/* Add text-center class here */}
            <Typography
                variant="small"
                color="blue-gray"
                className="mb-3 text-white text-lg uppercase font-semibold"
            ...
            {items.map((link) => (
                ...
                <div className="mt-12 flex flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
                    <Typography
                        ...
                        className="mb-4 text-center text-white font-normal md:mb-0"
                    >
                        &copy; {currentYear} <Link to="/">EdLernity</Link>. All Rights Reserved.
                    </Typography>
